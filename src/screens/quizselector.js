    ...
    render() {
        ...
        return(
            <ScrollView>
                    ...
                    >
                        <ImageBackground source={{uri:'https://previews.123rf.com/images/sergeybitos/sergeybitos1805/sergeybitos180500025/101122405-futuristic-concept-hud-gui-style-screen-dashboard-futuristic-circle-space-elements-info-graphics-vec.jpg'}} style={{width: '100%', height: '100%', borderRadius:10}}>
                            <View style={{flex:1}}/>
                            <View style={{backgroundColor: '#000', opacity:0.6, height:70, justifyContent:'space-between'}}>
