...
export default class Quiz extends React.Component {
    ...
    send_to_server = () => {
        ...
        var json = {
            ...
            quiz_level: this.quizLevel,
            wrong_qs: this.wrong_answers,
            total_qs: this.questions.length,
            total_wrong_qs: this.wrong_answers.length
        };
    ...
    check_answers = () => {
        ...
        if (this.arraysEqual(this.user_answers[this.state.qsIndex].answer, this.questions[this.state.qsIndex].answer)) {
            ...
            this.wrong_answers.push({
                qsId: this.questions[this.state.qsIndex].qsId,
                qsTopic: this.questions[this.state.qsIndex].qsTopic
            });
                                    ...
                                    {this.arraysEqual(rowData.answer, this.user_answers[rowID].answer) ?
                                        ...
                                        <View style={{flex: 1, flexDirection: 'row'}}>
                                            ...
                                            <Icon
                                                ...
                                                color='#ff1c1c'
                                                size={28}/><Text
                                            style={{lineHeight: 22, fontWeight: 'bold'}}> Wrong</Text></View>}
