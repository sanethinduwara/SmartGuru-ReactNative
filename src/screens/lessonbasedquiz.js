...
export default class Quiz extends React.Component {
    ...
    send_to_server = () => {
        ...
        var json = {user_id: this.state.userID, chapter:this.chapter_name, quiz_level:this.quizLevel, wrong_qs: this.wrong_answers, total_qs: this.questions.length, total_wrong_qs:this.questions.length-this.wrong_answers.length};
