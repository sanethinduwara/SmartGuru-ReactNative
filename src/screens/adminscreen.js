    ...
    render() {
        ...
        return(
            <View>
                ...
                >
                    <ImageBackground source={{uri:'https://www.maketecheasier.com/assets/uploads/2016/09/settings-app-not-working-featured.jpg'}} style={{width: '100%', height: '100%', borderRadius:10}}>
                        <View style={{flex:1}}/>
